...
#' @title Provenances operations
#' @description phisWSClientRTools.Provenances
#'
...
#' \describe{
#'
#' get_provenances Get all provenances corresponding to the search params given
#'
#'
#' post4 Post provenance(s)
#'
#'
#' put3 Update provenance
#'
#' }
#'
#' @export
ProvenancesApi <- R6::R6Class(
  'ProvenancesApi',
  public = list(
    ...
    get_provenances = function(page_size,page,uri,label,comment,json_value_filter,...){
      args <- list(...)
      queryParams <- list()
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        ...
        if(method == "GET"){
          ...
          for(i in 1:nrow(data)){
            row <- data[i,]
            returnObject <- ProvenanceDTO$new()
