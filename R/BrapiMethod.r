  ...
  public = list(
    ...
    toJSONString = function() {
       sprintf(
        ...
        jsonlite::toJSON(self$`methodDbId`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`methodName`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`brapiClass`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`description`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`formula`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`ontologyReference`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`reference`,auto_unbox=TRUE)
      )
    },
