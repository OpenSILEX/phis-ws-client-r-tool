  ...
  public = list(
    ...
    toJSONString = function() {
       sprintf(
        ...
        jsonlite::toJSON(self$`traitDbId`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`traitName`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`brapiclass`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`description`,auto_unbox=TRUE),
        lapply(self$`synonyms`, function(x) paste(paste0('"', x, '"'), sep=",")),
        jsonlite::toJSON(self$`mainAbbreviation`,auto_unbox=TRUE),
        lapply(self$`alternativeAbbreviations`, function(x) paste(paste0('"', x, '"'), sep=",")),
        jsonlite::toJSON(self$`entity`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`attribute`,auto_unbox=TRUE),
