  ...
  public = list(
    ...
    toJSONString = function() {
       sprintf(
        ...
        jsonlite::toJSON(self$`s`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`p`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`o`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`o_type`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`o_lang`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`g`,auto_unbox=TRUE)
      )
    },
