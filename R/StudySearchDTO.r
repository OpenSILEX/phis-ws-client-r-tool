  ...
  public = list(
    ...
    toJSONString = function() {
       sprintf(
        ...
        jsonlite::toJSON(self$`seasonDbId`,auto_unbox=TRUE),
        lapply(self$`studyDbIds`, function(x) paste(paste0('"', x, '"'), sep=",")),
        lapply(self$`studyNames`, function(x) paste(paste0('"', x, '"'), sep=",")),
        jsonlite::toJSON(self$`sortBy`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`sortOrder`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`page`,auto_unbox=TRUE),
