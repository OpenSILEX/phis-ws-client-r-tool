  ...
  public = list(
    ...
    toJSONString = function() {
       sprintf(
        ...
        jsonlite::toJSON(self$`installation`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`groupPlotType`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`groupPlotAlias`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`groupPlotUri`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`groupPlotSpecies`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`pilot`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`cameraType`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`cameraAlias`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`cameraUri`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`vectorType`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`vectorAlias`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`vectorUri`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`radiometricTargetAlias`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`radiometricTargetUri`,auto_unbox=TRUE)
      )
    },
