...
#' @description phisWSClientRTools.Api
#'
...
#' \describe{
#'
#' get_api_description Retrieve informations about OpenSILEX API
#'
#' }
#'
#' @export
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        ...
        if(method == "GET"){
          ...
          for(i in 1:nrow(data)){
            row <- data[i,]
            returnObject <- ApiDescriptionDTO$new()
