  ...
  public = list(
    ...
    toJSONString = function() {
       sprintf(
        ...
        jsonlite::toJSON(self$`address`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`phone`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`affiliation`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`orcid`,auto_unbox=TRUE),
        jsonlite::toJSON(self$`admin`,auto_unbox=TRUE),
