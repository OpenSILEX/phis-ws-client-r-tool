...
#' @description opensilexWSClient.Factors
#'
...
#' \describe{
#'
#' get_factors_by_criteria Get all factor corresponding to the search params given
#'
#'
#' post_unit Post factor(s)
#'
#' }
#'
#' @export
FactorsApi <- R6::R6Class(
  ...
  public = list(
    ...
    get_factors_by_criteria = function(page_size,page,uri,label,language,...){
      args <- list(...)
      queryParams <- list()
