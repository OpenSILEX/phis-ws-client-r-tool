...
ScientificObjectsApi <- R6::R6Class(
  ...
  public = list(
    ...
    get_scientific_objects_by_search = function(page_size,page,uri,experiment,alias,rdf_type,with_properties,...){
      args <- list(...)
      queryParams <- list()
      ...
      if (!missing(`with_properties`)) {
        queryParams['withProperties'] <- with_properties
      }
